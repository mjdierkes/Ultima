...
public class Tile 
{
	...
	public static final int SIZE = 50;					// Size of a tile in pixels
	...
	{
		double drawX = (x + 0.5) * SIZE;
		double drawY = (y + 0.5) * SIZE;
		
		if (lit)
		{
			switch (type)
			{
				case FLOOR:		StdDraw.picture(drawX, drawY, "brickfloor.gif", SIZE, SIZE); 	break;
				case LAVA:		StdDraw.picture(drawX, drawY, "lava.gif", SIZE, SIZE); 			break;
				case WATER:		StdDraw.picture(drawX, drawY, "water.gif", SIZE, SIZE);     	break;
				case GRASS:		StdDraw.picture(drawX, drawY, "grasslands.gif", SIZE, SIZE); 	break;
				case FOREST:	StdDraw.picture(drawX, drawY, "forest.gif", SIZE, SIZE);    	break;
				case MOUNTAIN:	StdDraw.picture(drawX, drawY, "mountains.gif", SIZE, SIZE); 	break;
				case WALL:		StdDraw.picture(drawX, drawY, "stonewall.gif", SIZE, SIZE); 	break;
			    default:                                            				break;										
			}			
		}
		else
		{
			StdDraw.picture(drawX, drawY, "blank.gif", SIZE, SIZE);
		}
	}
