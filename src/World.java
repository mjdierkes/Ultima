...
public class World
{
	...
	public World(String filename)
	{
		...
		{
			Thread thread = new Thread(monster); //monster is-a Runnable
			thread.start();
		}
	}
	...
	private int light(int x, int y, int currentX, int currentY, double r)
	{
		...
		double euclideanDistance = Math.sqrt(Math.pow(currentX - x, 2)
		...
		return 1 + light(x, y, currentX + 1, currentY, r) +
				light(x, y, currentX, currentY + 1, r) +
				light(x, y, currentX - 1, currentY, r) +
				light(x, y, currentX, currentY - 1, r);
	}
